...
const app = {
    ...
    loadDemoData() {
        ...
        const demoTrades = [
            { id: 'demo1', date: '2026-04-20', asset: 'BTC', type: 'crypto', direction: 'long', entryPrice: 68000, exitPrice: 71500, positionSize: 0.5, notes: 'Broke resistance at 70k, strong volume', createdAt: '2026-04-20T10:00:00Z' },
            { id: 'demo2', date: '2026-04-21', asset: 'ETH', type: 'crypto', direction: 'long', entryPrice: 3200, exitPrice: 2980, positionSize: 2, notes: 'Stopped out, should have waited for confirmation', createdAt: '2026-04-21T14:00:00Z' },
            { id: 'demo3', date: '2026-04-22', asset: 'EUR/USD', type: 'forex', direction: 'short', entryPrice: 1.0950, exitPrice: 1.0880, positionSize: 10000, notes: 'DXY strength, good technical setup', createdAt: '2026-04-22T09:00:00Z' },
            { id: 'demo4', date: '2026-04-23', asset: 'SOL', type: 'crypto', direction: 'long', entryPrice: 145, exitPrice: 162, positionSize: 10, notes: 'NFT volume spike, momentum trade', createdAt: '2026-04-23T11:00:00Z' },
            { id: 'demo5', date: '2026-04-24', asset: 'GBP/USD', type: 'forex', direction: 'long', entryPrice: 1.2750, exitPrice: 1.2680, positionSize: 5000, notes: 'BoE dovish tone, lost on news', createdAt: '2026-04-24T08:00:00Z' },
            { id: 'demo6', date: '2026-04-25', asset: 'AAPL', type: 'stocks', direction: 'long', entryPrice: 185.50, exitPrice: 192.30, positionSize: 50, notes: 'Earnings beat, gap up play', createdAt: '2026-04-25T15:00:00Z' },
            { id: 'demo7', date: '2026-04-26', asset: 'XAU/USD', type: 'commodities', direction: 'short', entryPrice: 2350, exitPrice: 2320, positionSize: 1, notes: 'Profit taking after ATH', createdAt: '2026-04-26T10:00:00Z' },
            { id: 'demo8', date: '2026-04-27', asset: 'ETH', type: 'crypto', direction: 'short', entryPrice: 3350, exitPrice: 3280, positionSize: 1.5, notes: 'Overextended on daily, RSI divergence', createdAt: '2026-04-27T13:00:00Z' },
            { id: 'demo9', date: '2026-04-28', asset: 'USD/JPY', type: 'forex', direction: 'long', entryPrice: 152.30, exitPrice: 153.80, positionSize: 8000, notes: 'Carry trade momentum, BOJ intervention risk managed', createdAt: '2026-04-28T09:00:00Z' },
            { id: 'demo10', date: '2026-04-28', asset: 'BTC', type: 'crypto', direction: 'short', entryPrice: 72000, exitPrice: 73500, positionSize: 0.3, notes: 'FOMO short, wrong timing. Lesson: wait for structure', createdAt: '2026-04-28T16:00:00Z' },
        ];
    ...
    // =========================================
    renderTrades() {
        const { tradesTableBody, emptyState, searchTrades, filterType, filterResult } = this.elements;
